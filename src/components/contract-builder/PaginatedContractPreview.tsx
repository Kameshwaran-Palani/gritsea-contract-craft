...
const PaginatedContractPreview: React.FC<PaginatedContractPreviewProps> = ({ data }) => {
    ...
    <div className="contract-preview h-full overflow-auto bg-gray-100 p-8">
      ...
      <div className="space-y-8">
        {pages.map((page, index) => (
          <div
            key={index}
            className="mx-auto bg-white shadow-lg border border-gray-200 page-break-after"
            style={{
              width: `${PAGE_WIDTH}px`,
