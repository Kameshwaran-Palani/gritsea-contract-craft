...
const DocumentHeaderStyling: React.FC<DocumentHeaderStylingProps> = ({ data, updateData }) => {
  ...
  return (
    <div className="space-y-6">
      {/* Background Images Section - Now at the top for visibility */}
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            <Label className="text-sm font-medium">Header Background Image</Label>
          ...
          <div>
            <Label className="text-sm font-medium">Document Background Image</Label>
